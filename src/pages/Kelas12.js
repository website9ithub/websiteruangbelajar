...
const Materi = () => {
  ...
  useEffect(() => {
    const mockBiologies = [
      { id: 1, name: 'Try Out 1', category: 'Bab 1', link: '/TO12b1' },
      { id: 2, name: 'Try Out 2', category: 'Bab 2', link: '/TO12b2' },
      { id: 3, name: 'Try Out 3', category: 'Bab 3', link: '/TO12b3' },
      { id: 4, name: 'Try Out 4', category: 'Bab 4', link: '/TO12b4' },
      { id: 5, name: 'Try Out 5', category: 'Bab 5', link: '/TO12b5' },
      { id: 6, name: 'Try Out 6', category: 'Bab 6', link: '/TO12b6' },
      { id: 7, name: 'Try Out 7', category: 'Bab 7', link: '/TO12b7' },
      { id: 8, name: 'Try Out 8', category: 'Bab 8', link: '/TO12b8' },
    ];
